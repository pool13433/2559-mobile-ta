...
CREATE TABLE IF NOT EXISTS `accessory` (
  ...
  `acc_createdate` timestamp NOT NULL  COMMENT 'วันที่สร้างอุปกรณ์เสริม',
  `acc_createby` int(11) NOT NULL COMMENT 'ผู้สร้างอุปกรณ์เสริม',
  `acc_updatedate` timestamp NOT NULL  COMMENT 'วันที่แก้ไขอุปกรณ์เสริม',
...
CREATE TABLE IF NOT EXISTS `brand` (
  ...
  `bra_createdate` timestamp NOT NULL ,
  `bra_createby` int(11) NOT NULL,
  `bra_updatedate` timestamp NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `color` (
  ...
  `col_createdate` timestamp NOT NULL ,
  `col_createby` int(11) NOT NULL,
  `col_updatedate` timestamp NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `model` (
  ...
  `mod_createdate` timestamp NOT NULL ,
  `mod_createby` int(11) NOT NULL,
  `mod_updatedate` timestamp NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `person` (
  ...
  `per_createdate` timestamp NOT NULL ,
  `per_createby` int(11) NOT NULL,
  `per_updatedate` timestamp NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `prefix` (
  ...
  `pre_createdate` timestamp NOT NULL ,
  `pre_createby` int(11) NOT NULL,
  `pre_updatedate` timestamp NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `problem` (
  ...
  `prob_createdate` timestamp NOT NULL ,
  `prob_createby` int(11) NOT NULL,
  `prob_updatedate` timestamp NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `prod_createdate` timestamp NOT NULL ,
  `prod_createby` int(11) NOT NULL,
  `prod_updatedate` timestamp NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `repair` (
  ...
  `inrep_updatedate` timestamp NOT NULL ,
