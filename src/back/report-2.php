<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal" name="frm-report-3" id="frm-report-3" method="get" action="pdf-report-2.php">
            <div class="form-group">
                <label for="input-desc" class="col-sm-2 control-label">รายละเอียด</label>
                <div class="col-sm-10">
                    <label class="radio-inline">รายงาน ข้อมูลการซ่อมของช่างแต่ละคน
                    </label>
                </div>
            </div>                
            <div class="form-group">
